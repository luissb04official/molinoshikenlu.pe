    ...
    <div class="container py-5">
        <div class="row align-items-center">
            <div class="col-lg-6 pe-lg-5">
                <h1 class="display-4 fw-bold mb-4" style="color: #d67958; font-family: 'Montserrat', sans-serif; text-shadow: 2px 2px 4px rgba(0,0,0,0.1);">
                    <i class="fas fa-leaf me-3" style="color: #8b9949;"></i>
                    Nutrición Balanceada para cada Animal
                </h1>
                <p class="lead mb-4" style="font-size: 1.2rem; line-height: 1.6; color: #5a5a5a;">
                    En <span class="fw-semibold" style="color: #8b9949;">Molinos Hikenlu</span> entendemos que cada animal es único. 
                    Por eso, desarrollamos alimentos especializados que garantizan un <span class="fw-semibold">crecimiento saludable</span> y 
                    una <span class="fw-semibold">producción óptima</span>.
                </p>
